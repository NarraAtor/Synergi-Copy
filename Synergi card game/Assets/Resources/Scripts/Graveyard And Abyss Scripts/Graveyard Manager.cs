...
{
    //I'm making this a stack so that future me gets the idea.
    private Stack<Card> GraveyardArray;
    ...
    void Start()
    {
        ...
        TacticScript = this.gameObject.GetComponent<Tactic>();
